...
curl --location http://dl.google.com/android/ndk/android-ndk32-r10-linux-x86_64.tar.bz2 | tar -x  &
curl --location http://dl.google.com/android/android-sdk_r23.0.2-linux.tgz | tar -x &
wait
