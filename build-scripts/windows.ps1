...
Write-Host "Creating `${Env:BUILD_BIN} in ${Env:BUILD_HOME}\bin"
New-Item "${Env:BUILD_HOME}\bin" `
     -ItemType directory `
     -Force `
     ; ${Env:BUILD_BIN} = "${Env:BUILD_HOME}\bin"

Write-Host "Creating `${Env:BUILD_ASSETS} in ${Env:BUILD_HOME}\assets"
New-Item "${Env:BUILD_HOME}\assets" `
     -ItemType directory `
     -Force `
     ; ${Env:BUILD_ASSETS} = "${Env:BUILD_HOME}\assets"

Write-Host "Creating `${Env:BUILD_RELEASE} in ${Env:BUILD_HOME}\release"
